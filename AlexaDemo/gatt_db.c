...
{
0xfb, 0x34, 0x9b, 0x5f, 0x80, 0x00, 0x00, 0x80, 0x00, 0x10, 0x00, 0x00, 0x03, 0xfe, 0x00, 0x00, 
0x76, 0x30, 0xf8, 0xdd, 0x90, 0xa3, 0x61, 0xac, 0xa7, 0x43, 0x05, 0x30, 0x77, 0xb1, 0x4e, 0xf0, 
0x0b, 0x42, 0x82, 0x1f, 0x64, 0x72, 0x2f, 0x8a, 0xb4, 0x4b, 0x79, 0x18, 0x5b, 0xa0, 0xee, 0x2b, 
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_17 ) = {
	.len=5,
	.data={0x02,0x13,0x00,0x01,0x2a,}
};
uint8_t bg_gattdb_data_attribute_field_16_data[10]={0x41,0x6c,0x65,0x78,0x61,0x20,0x44,0x65,0x6d,0x6f,};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_11 ) = {
	.len=19,
	.data={0x12,0x0d,0x00,0x0b,0x42,0x82,0x1f,0x64,0x72,0x2f,0x8a,0xb4,0x4b,0x79,0x18,0x5b,0xa0,0xee,0x2b,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_9 ) = {
	.len=19,
	.data={0x08,0x0b,0x00,0x76,0x30,0xf8,0xdd,0x90,0xa3,0x61,0xac,0xa7,0x43,0x05,0x30,0x77,0xb1,0x4e,0xf0,}
};
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_8 ) = {
	.len=16,
	.data={0xfb,0x34,0x9b,0x5f,0x80,0x00,0x00,0x80,0x00,0x10,0x00,0x00,0x03,0xfe,0x00,0x00,}
};
...
GATT_DATA(const struct bg_gattdb_attribute bg_gattdb_data_attributes_map[])={
    ...
    {.uuid=0x8001,.permissions=0x902,.caps=0xffff,.datatype=0x07,.dynamicdata=&bg_gattdb_data_attribute_field_10},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_11},
    {.uuid=0x8002,.permissions=0x1811,.caps=0xffff,.datatype=0x07,.dynamicdata=&bg_gattdb_data_attribute_field_12},
    {.uuid=0x000e,.permissions=0x907,.caps=0xffff,.datatype=0x03,.configdata={.flags=0x01,.index=0x04,.clientconfig_index=0x01}},
    {.uuid=0x0000,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_14},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_15},
    {.uuid=0x0004,.permissions=0x803,.caps=0xffff,.datatype=0x01,.dynamicdata=&bg_gattdb_data_attribute_field_16},
    ...
    {.uuid=0x0000,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_19},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_20},
    {.uuid=0x0007,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_21},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_22},
    {.uuid=0x0008,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_23},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_24},
    {.uuid=0x0009,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_25},
